...
fn test_swap() {
    ...
    let vault_bal_res: BalanceResponse = app
        ...
        .unwrap();
    assert_eq!(Uint128::from(9999999011u128), vault_bal_res.balance);
    ...
    let keeper_bal_res: BalanceResponse = app
        ...
        .unwrap();
    assert_eq!(Uint128::from(19u128), keeper_bal_res.balance);
    let vault_pool_config_res: PoolInfoResponse = app
        .wrap()
        .query_wasm_smart(
            &vault_instance.clone(),
    ...
    assert_eq!(
        vec![
            ...
            Asset {
                ...
                amount: Uint128::from(9999999011u128),
            },
        ],
        vault_pool_config_res.assets
    );
    ...
    let vault_bal_res: BalanceResponse = app
        ...
        .unwrap();
    assert_eq!(Uint128::from(10000000041u128), vault_bal_res.balance);
    ...
    let keeper_bal_after = app
        ...
        .unwrap();
    assert_eq!(
        keeper_bal_before.amount + Uint128::from(19u128),
