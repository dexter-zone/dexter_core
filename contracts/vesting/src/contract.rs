...
const CONTRACT_NAME: &str = "dexter-vesting";
...
/// [`ContractError`].
/// ## Params
/// * **addr** is the object of type [`Addr`]. Sets the address of the contract for which the error will be returned
